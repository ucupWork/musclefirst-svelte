...
import Testi1 from '$images/product/pro-isolate/testimonial/testi-01.webp'
import Testi2 from '$images/product/pro-isolate/testimonial/testi-02.webp'
import Testi3 from '$images/product/pro-isolate/testimonial/testi-03.webp'
import Testi4 from '$images/product/pro-isolate/testimonial/testi-04.webp'
...
export const ingredientsDescription: IngredientsDescription = {
        id: "1",
        description: 'Isolate Protein Whey, Bubuk Pisang, Bubuk Kopi, Krimer Nabati, Isomalto Oligosakrida, Inulin, BCAA, Presia Vanila, Premiks Vitamin dan Mineral, Pemanis Alami, Glikosida Steviol, Vitamin B6. <br> <span class="italic">Whey Protein Isolate, Banana Powder, Coffee Powder, Non Dairy Creamer, Isomalto Oligasaccharide, Inulin, BCAA, Vanilla Flavor, Vitamin Premix and Mineral, Natural Sweeteners Steviol Glycosides, Vitamin B6</span>',
};
export const servingSuggestion: ServingSuggestion = {
        id: "1",
        description: 'Larutkan ( 1 Scoop 35g ) dalam 150ml air <br> <span class="italic">Dissolve ( 1 Scoop 35g ) in 150ml water.</span>',
};
