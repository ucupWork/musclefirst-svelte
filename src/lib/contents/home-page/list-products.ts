...
export const productList: CardProduct[] = [
    {
      id: "1",
      code: "M1PGPI01",
      typeProduct: "Gold", 
...
// Gain Muscle List
export const productGainMuscleList: CardProduct[] = [
  {
    id: "1",
    name: "Pro Gainer",
    linkHref: "products/pro-gainer",
    imgUrl: cdn ? `https://musclefirst-space.sgp1.cdn.digitaloceanspaces.com/Musclefirst/product/optimize/pro-2.webp` : 'https://musclefirst-space.sgp1.cdn.digitaloceanspaces.com/Musclefirst/product/new-product/pro-gainer/pronew-02_xs8ik9.png',
    imgAlt: "Musclefirst Pro Gainer"
  ...
  },
  {
    ...
    name: "Pro Isolate",
    linkHref: "products/pro-isolate",
    imgUrl: cdn ? `https://musclefirst-space.sgp1.cdn.digitaloceanspaces.com/Musclefirst/product/optimize/pro-1.webp` : 'https://musclefirst-space.sgp1.cdn.digitaloceanspaces.com/Musclefirst/product/new-product/pro-isolate/pronew-01_xhisub.png',
    imgAlt: "Musclefirst Pro Isolate"
  ...
  },
  {
    ...
    name: "Pro Creatine",
    linkHref: "products/pro-creatine",
    imgUrl: cdn ? `https://musclefirst-space.sgp1.cdn.digitaloceanspaces.com/Musclefirst/product/optimize/pro-6.webp` : 'https://musclefirst-space.sgp1.cdn.digitaloceanspaces.com/Musclefirst/product/new-product/pro-creatine/pronew-06_grknvm.png',
    imgAlt: "Musclefirst Pro Creatine"
  ...
  },
  {
    ...
    name: "Pro Casein",
    linkHref: "products/pro-casein",
    imgUrl: cdn ? `https://musclefirst-space.sgp1.cdn.digitaloceanspaces.com/Musclefirst/product/optimize/pro-4.webp` : 'https://musclefirst-space.sgp1.cdn.digitaloceanspaces.com/Musclefirst/product/new-product/pro-casein/pronew-04_yaaspe.png',
    imgAlt: "Musclefirst Pro Casein"

  },
]
// Weight Loss List
export const productWeightLossList: CardProduct[] = [
  {
    id: "1",
    name: "Pro Whey",
    linkHref: "products/pro-whey",
    imgUrl: cdn ? `https://musclefirst-space.sgp1.cdn.digitaloceanspaces.com/Musclefirst/product/optimize/pro-3.webp` : 'https://musclefirst-space.sgp1.cdn.digitaloceanspaces.com/Musclefirst/product/new-product/pro-whey/pronew-03_tjnsg9.png',
    imgAlt: "Musclefirst Pro Whey"
  ...
  },
  {
    ...
    name: "Pro BCAA",
    linkHref: "products/pro-bcaa",
    imgUrl: cdn ? `https://musclefirst-space.sgp1.cdn.digitaloceanspaces.com/Musclefirst/product/optimize/pro-5.webp` : 'https://musclefirst-space.sgp1.cdn.digitaloceanspaces.com/Musclefirst/product/new-product/pro-bcaa/pronew-05_pcwx1q.png',
    imgAlt: "Musclefirst Pro BCAA"
...
// Strength Endurance List
export const productStrengthList: CardProduct[] = [
    {
      id: "1",
      name: "Pro Creatine",
      linkHref: "products/pro-creatine",
    ...
    },
    {
      ...
      name: "Pro Nrgy",
      linkHref: "products/pro-nrgy",
      imgUrl: cdn ? `https://musclefirst-space.sgp1.cdn.digitaloceanspaces.com/Musclefirst/product/optimize/pro-7.webp` : 'https://musclefirst-space.sgp1.cdn.digitaloceanspaces.com/Musclefirst/product/new-product/pro-nrgy/pronew-07_g8tozm.png',
      imgAlt: "Musclefirst Pronrgy"
