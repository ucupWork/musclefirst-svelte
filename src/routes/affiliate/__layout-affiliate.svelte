...
<script lang="ts">
	...
	import { state, waPopUpButton } from '$stores/index';
    ...
    const togglePopWa = async () => {
        $waPopUpButton = !$waPopUpButton
    }
...
{/if}
<!-- TopTop -->
<TopTop classes="left-2 bottom-8 md:bottom-8" />
<div class="relative flex flex-col justify-center items-center w-full h-auto overflow-auto scroll-smooth scrollbar-thin scrollbar-thumb-zinc-900 scrollbar-track-bg-transparent bg-white">
    ...
    <div class="fixed bottom-8 right-8 w-full z-20">
        <div class="flex justify-end items-start m-auto px-6">
            <a rel="noreferrer" href="https://wa.me/628118806632/?text=Info+Dari+Website+%3A%22Hallo%2C+Saya+tertarik+dengan+produk+Musclefirst+,+Saya+Dapat+Penawaran+Dari+Website%22&type=phone_number&app_absent=0" class="hidden space-x-4 md:flex md:items-center shadow-xl rounded-full w-auto md:w-96 border bg-white px-4 p-2">
                ...
                <div class="text-gray-600 dark:text-gray-400">
                    ...
                    <p class="text-xs font-semibold text-gray-700 dark:text-gray-300">Hubungi asisten kami, sekarang</p>
                </div>
            </a>
            <button on:click={togglePopWa} class="flex justify-center items-center w-6 h-6 rounded-full object-cover bg-gradient-to-tr from-gray-500 to-zinc-500">
