...
<script lang="ts">
    ...
    import { ModalGainerIndex } from '$section/product/index';
    // Section
    import { 
        SectionOne,
        SectionTwo,
	...
	import { 
        ...
        testimonialCardList, 
        educationCardList 
    } from '$contents/landing-page/v-one/gainer/index';
	import { productList } from '$contents/home-page/list-products';
    import { certifiedList } from '$contents/product-page/list-certified';

    import BannerJumbotron from '$images/product/pro-gainer/banner-jumbotron.webp';
    import GainerOne from '$images/product/pro-gainer/produk-01-1.webp';
    import GainerTwo from '$images/product/pro-gainer/produk-03.webp';
    import EducationImg from '$images/product/pro-gainer/optimize/education-product-img.webp';
    import FeatureImage from  '$images/product/pro-gainer/produk-02-3.webp';
    ...
    let harga6lbsActual = 'Rp455.000';
    let orderButton= false;

    const showModal = () => modal.set(ModalGainerIndex);
</script>
