...
<script lang="ts">
    ...
    import { ModalWheyIndex } from '$section/product/index';
    // Section
    import { 
        SectionOne,
        SectionTwo,
	...
	import { 
        ...
        testimonialCardList, 
        educationCardList 
    } from '$contents/landing-page/v-one/whey/index';
	import { productList } from '$contents/home-page/list-products';
    import { certifiedList } from '$contents/product-page/list-certified';

    import BannerJumbotron from '$images/product/pro-whey/banner-jumbotron.webp';
    import WheyOne from '$images/product/pro-whey/produk-01-1.webp';
    import WheyTwo from '$images/product/pro-whey/produk-03.webp';
    import EducationImg from '$images/product/pro-whey/optimize/education-product-img.webp';
    import FeatureImage from  '$images/product/pro-whey/produk-02-3.webp';
    ...
    const showModal = () => modal.set(ModalWheyIndex);
</script>
