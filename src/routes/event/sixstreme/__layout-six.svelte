...
<div class="relative flex flex-col justify-center items-center w-full h-auto overflow-auto scroll-smooth scrollbar-thin scrollbar-thumb-zinc-900 scrollbar-track-bg-transparent bg-black">
    ...
    <div class="fixed inset-x-0 bottom-0 flex md:hidden w-full h-auto z-50">
        <div class="w-full h-auto p-4">
            <button on:click={() => scrollTo('#fillForm')} class="flex justify-between items-center w-full h-auto bg-gradient-to-r from-orange-700 to-yelow-500 rounded-full border border-black py-4 md:py-8 px-4">
                <span class="font-blackttnorms font-black text-md text-white">Gabung Sekarang</span>
                <svg xmlns="http://www.w3.org/2000/svg" class="text-white w-4 h-4 icon icon-tabler icon-tabler-chevron-right" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
