...
const Testi1 = "/_app/immutable/assets/testi-01-f2019d35.webp";
const Testi2 = "/_app/immutable/assets/testi-01-f2019d35.webp";
const Testi3 = "/_app/immutable/assets/testi-03-45c73835.webp";
const Testi4 = "/_app/immutable/assets/testi-04-ab4a8117.webp";
const cocokCardList = [
  {
    id: "1",
...
const BannerJumbotron = "/_app/immutable/assets/banner-jumbotron-92767b2e.webp";
const WheyOne = "/_app/immutable/assets/produk-01-1-608bff3f.webp";
const EducationImg = "/_app/immutable/assets/education-product-img-230f2a0f.webp";
const FeatureImage = "/_app/immutable/assets/produk-02-3-dece3a06.webp";
...
let crownPin = false;
let hargaActual = "Rp285.000";
let orderButton = false;
const Index_whey = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${validate_component(SectionOne, "SectionOne").$$render(
    $$result,
    {
      ...
      txtPenawaran: "BODY GOALS UNTUK PEMULA DENGAN HARGA TERJANGKAU",
...
${validate_component(SectionThirteen, "SectionThirteen").$$render(
    $$result,
    {
      ...
      btnText: "Beli Sekarang!!",
      descText: 'Mengandung <span class="text-amber-500 font-bold">24 gram</span> protein per saji yang mampu menambah massa otot lebih berisi, kamu sudah bisa dapatkan <span class="text-amber-500 font-bold">140 KALORI</span> per saji. Selain itu, dengan konsumsi Pro whey <span class="text-amber-500 font-bold">1 gram</span> lemak sebagai bahan energi yang menyimpan energi dalam tubuh.'
    },
    {},
    {}
  )}
...
${validate_component(SectionNine, "SectionNine").$$render(
    ...
    {
      orderButton,
      classShopee: "whey-shopee",
      classWa: "whey-wa",
      subtitle: "Order Now",
      title: productName,
      description: "Pesan sekarang dengan voucher diskon di marketplace kesayanganmu atau hubungi kontak di bawah ini",
      linkShopee: "https://shopee.co.id/universal-link/product/8802988/5876940790?deep_and_web=1&utm_campaign=s8802988_ss_id_webs_lpprowhey_bp&utm_source=website&utm_medium=affiliates&utm_source=an_11373210424&utm_content=lpprowhey&smtt=9",
      ...
      linkOrderOnline: "https://musclefirst.orderonline.id/muscle-first-pro-whey"
    },
    {},
    {}
  )}
