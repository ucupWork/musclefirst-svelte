...
import { i as infoAllArticlesQuery } from "../../../../../_app/immutable/chunks/article-queries-62221a2a.js";
...
const Index_blog = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let { infoAllArticles } = $$props;
  if ($$props.infoAllArticles === void 0 && $$bindings.infoAllArticles && infoAllArticles !== void 0)
    $$bindings.infoAllArticles(infoAllArticles);
...
<div class="${"w-full h-auto pt-4 md:pt-10"}">${validate_component(Main, "InformasiMain").$$render($$result, { allArticles: infoAllArticles }, {}, {})}</div>`;
});
export {
